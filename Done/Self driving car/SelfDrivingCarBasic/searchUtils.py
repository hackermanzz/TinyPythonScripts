...
class searchUtils():
    ...
    def retrieveActionStateSequenceFromState(self,state):
        visitedstatelist = []
        action_sequence=[]
        state_sequence=[]
        ...
        for i in range(len(visitedstatelist)-1):
            ...
            state_sequence.append(visitedstatelist[i]["location"])
            #print(visitedstatelist[i]["location"])
        state_sequence.append(visitedstatelist[len(visitedstatelist)-1]["location"])
